...
from ULC.yolo.utils import LINUX, LOGGER, ROOT, yaml_load
from ULC.yolo.utils.checks import check_requirements, check_suffix, check_version, check_yaml
from ULC.yolo.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    ...
    def __init__(self,
                 ...
                 verbose=True):
        """
        MultiBackend class for python inference on various platforms using ULC YOLO.
        ...
        if nn_module:
            ...
            from ULC.nn.tasks import attempt_load_weights
            ...
            from ULC.yolo.engine.exporter import gd_outputs

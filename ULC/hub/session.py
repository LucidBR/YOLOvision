...
from ULC.hub.utils import HUB_API_ROOT, check_dataset_disk_space, smart_request
from ULC.yolo.utils import LOGGER, PREFIX, __version__, checks, emojis, is_colab, threaded
            ...
            if data.get('status', None) == 'trained':
                raise ValueError(
                    emojis(f'Model is already trained and uploaded to '
                           f'https://hub.ULC.com/models/{self.model_id} 🚀'))

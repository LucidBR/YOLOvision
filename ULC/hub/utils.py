...
from ULC.yolo.utils import (DEFAULT_CFG_DICT, ENVIRONMENT, LOGGER, ONLINE, RANK, SETTINGS, TESTS_RUNNING,
                                    TQDM_BAR_FORMAT, TryExcept, __version__, colorstr, emojis, get_git_origin_url,
                                    is_colab, is_git_dir, is_pip_package)

PREFIX = colorstr('ULC HUB: ')
HELP_MSG = 'If this issue persists please visit https://github.com/ULC/hub/issues for assistance.'
HUB_API_ROOT = os.environ.get('ULC_HUB_API', 'https://api.ULC.com')


def check_dataset_disk_space(url='https://ULC.com/assets/coco128.zip', sf=2.0):
...
class Traces:
    ...
    def __init__(self):
        ...
        self.enabled = \
            ...
            ONLINE and \
            (is_pip_package() or get_git_origin_url() == 'https://github.com/ULC/ULC.git')

...
from ULC.nn.tasks import ClassificationModel, attempt_load_one_weight
from ULC.yolo import v8
from ULC.yolo.data import build_classification_dataloader
from ULC.yolo.engine.trainer import BaseTrainer
from ULC.yolo.utils import DEFAULT_CFG, LOGGER, RANK, colorstr
from ULC.yolo.utils.torch_utils import is_parallel, strip_optimizer
...
class ClassificationTrainer(BaseTrainer):
    ...
    def setup_model(self):
        ...
        # Load a YOLO model locally, from torchvision, or from ULC assets

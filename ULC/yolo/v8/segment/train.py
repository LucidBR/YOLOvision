...
from ULC.nn.tasks import SegmentationModel
from ULC.yolo import v8
from ULC.yolo.utils import DEFAULT_CFG, RANK
from ULC.yolo.utils.ops import crop_mask, xyxy2xywh
from ULC.yolo.utils.plotting import plot_images, plot_results
from ULC.yolo.utils.tal import make_anchors
from ULC.yolo.utils.torch_utils import de_parallel
from ULC.yolo.v8.detect.train import Loss
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError('ERROR ❌ segment dataset incorrectly formatted or not a segment dataset.\n'
                            ...
                            'as an example.\nSee https://docs.ULC.com/tasks/segment/ for help.') from e

...
from ULC.yolo.utils import LOGGER, checks, is_online
            ...
            try:
                if curl or i > 0:  # curl download with retry, continue
                    ...
                    if method == 'torch':
                        ...
                        from ULC.yolo.utils import TQDM_BAR_FORMAT
...
def attempt_download_asset(file, repo='ULC/assets', release='v0.0.0'):
    # Attempt file download from GitHub release assets if not found locally. release = 'latest', 'v6.2', etc.
    from ULC.yolo.utils import SETTINGS  # scoped for circular import

...
from ULC.hub.utils import PREFIX, traces
from ULC.yolo.utils import LOGGER
from ULC.yolo.utils.torch_utils import get_flops, get_num_params
...
def on_pretrain_routine_end(trainer):
    ...
    if session:
        ...
        LOGGER.info(f'{PREFIX}View model at https://hub.ULC.com/models/{session.model_id} 🚀')

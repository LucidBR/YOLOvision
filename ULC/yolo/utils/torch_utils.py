...
from ULC.yolo.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, RANK, __version__
...
def select_device(device='', batch=0, newline=False, verbose=True):
    ...
    s = f'ULC YOLOv{__version__} 🚀 Python-{platform.python_version()} torch-{torch.__version__} '
...
def strip_optimizer(f: Union[str, Path] = 'best.pt', s: str = '') -> None:
    ...
    Usage:
        from ULC.yolo.utils.torch_utils import strip_optimizer
        from pathlib import Path

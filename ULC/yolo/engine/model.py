...
from ULC import yolo  # noqa
from ULC.nn.tasks import (ClassificationModel, DetectionModel, SegmentationModel, attempt_load_one_weight,
                                  guess_model_task, nn, yaml_model_load)
from ULC.yolo.cfg import get_cfg
from ULC.yolo.engine.exporter import Exporter
from ULC.yolo.utils import (DEFAULT_CFG, DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, RANK, ROOT, callbacks,
                                    is_git_dir, yaml_load)
from ULC.yolo.utils.checks import check_file, check_imgsz, check_pip_update_available, check_yaml
from ULC.yolo.utils.downloads import GITHUB_ASSET_STEMS
from ULC.yolo.utils.torch_utils import smart_inference_mode
...
class YOLO:
    ...
    Methods:
        ...
        predict(source=None, stream=False, **kwargs) -> List[ULC.yolo.engine.results.Results]:
            Performs prediction using the YOLO model.

    Returns:
        list(ULC.yolo.engine.results.Results): The prediction results.
    """
    ...
    def predict(self, source=None, stream=False, **kwargs):
        ...
        """
        if source is None:
            source = ROOT / 'assets' if is_git_dir() else 'https://ULC.com/images/bus.jpg'
            LOGGER.warning(f"WARNING ⚠️ 'source' is missing. Using 'source={source}'.")
        is_cli = (sys.argv[0].endswith('yolo') or sys.argv[0].endswith('ULC')) and \
    ...
    def track(self, source=None, stream=False, **kwargs):
        from ULC.tracker import register_tracker
    ...
    def benchmark(self, **kwargs):
        ...
        self._check_is_pytorch_model()
        from ULC.yolo.utils.benchmarks import benchmark

...
from ULC.nn.autobackend import check_class_names
from ULC.nn.modules import C2f, Detect, Segment
from ULC.nn.tasks import DetectionModel, SegmentationModel
from ULC.yolo.cfg import get_cfg
from ULC.yolo.utils import (DEFAULT_CFG, LINUX, LOGGER, MACOS, __version__, callbacks, colorstr,
                                    get_default_args, yaml_save)
from ULC.yolo.utils.checks import check_imgsz, check_requirements, check_version
from ULC.yolo.utils.files import file_size
from ULC.yolo.utils.ops import Profile
from ULC.yolo.utils.torch_utils import get_latest_opset, select_device, smart_inference_mode
...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        description = f'ULC {self.pretty_name} model ' + f'trained on {Path(self.args.data).name}' \
    ...
    def _export_coreml(self, prefix=colorstr('CoreML:')):
        ...
        class iOSDetectModel(torch.nn.Module):
            # Wrap an ULC YOLO model for iOS export

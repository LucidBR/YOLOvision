...
from YOLOvision.yolo.utils import LOGGER, checks, is_online

GITHUB_ASSET_NAMES = [f'YOLOvision{size}{suffix}.pt' for size in 'nsmlx' for suffix in ('', '6', '-cls', '-seg')] + \
            ...
            try:
                if curl or i > 0:  # curl download with retry, continue
                    ...
                    if method == 'torch':
                        ...
                        from YOLOvision.yolo.utils import TQDM_BAR_FORMAT

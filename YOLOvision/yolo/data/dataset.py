...
from .augment import Compose, Format, Instances, LetterBox, classify_albumentations, classify_transforms, vision_transforms
...
class YOLODataset(BaseDataset):
    ...
    def get_labels(self):
        ...
        try:
            import gc
            gc.disable()  # reduce pickle load time https://github.com/ULC/ULC/pull/1585

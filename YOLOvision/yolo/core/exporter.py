...
from YOLOvision.nn.autobackend import check_class_names
from YOLOvision.nn.modules import C2f, Detect, Segment
from YOLOvision.nn.tasks import DetectionModel, SegmentationModel
from YOLOvision.yolo.cfg import get_cfg
from YOLOvision.yolo.utils import (DEFAULT_CFG, LINUX, LOGGER, MACOS, __version__, callbacks, colorstr,
                                   get_default_args, yaml_save)
from YOLOvision.yolo.utils.checks import check_imgsz, check_requirements, check_version
from YOLOvision.yolo.utils.files import file_size
from YOLOvision.yolo.utils.ops import Profile
from YOLOvision.yolo.utils.torch_utils import get_latest_opset, select_device, smart_inference_mode
...
class Exporter:
    ...
    def __call__(self, model=None, *args, **kwargs):
        ...
        description = f'YOLOvision {self.pretty_name} model ' + f'trained on {Path(self.args.data).name}' \
            if self.args.data else '(untrained)'
        self.metadata = {
            'description': description,
            'author': 'YOLOvision',
            'license': 'GPL-3.0 https://ULC.com/license',
            'version': __version__,
    ...
    def _export_torchscript(self, prefix=colorstr('TorchScript:')):
        # YOLOvision TorchScript model export
    ...
    def _export_saved_model(self, prefix=colorstr('TensorFlow SavedModel:')):
        ...
        # YOLOvision TensorFlow SavedModel export
        try:
    ...
    def _export_pb(self, keras_model, prefix=colorstr('TensorFlow GraphDef:')):
        # YOLOvision TensorFlow GraphDef *.pb export https://github.com/leimao/Frozen_Graph_TensorFlow
        import tensorflow as tf  # noqa
    ...
    def _export_tflite(self, keras_model, nms, agnostic_nms, prefix=colorstr('TensorFlow Lite:')):
        # YOLOvision TensorFlow Lite export
        import tensorflow as tf  # noqa
    ...
    def _export_tfjs(self, prefix=colorstr('TensorFlow.js:')):
        # YOLOvision TensorFlow.js export

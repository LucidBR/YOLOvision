...
from YOLOvision.yolo.utils import LINUX, LOGGER, ROOT, yaml_load
from YOLOvision.yolo.utils.checks import check_requirements, check_suffix, check_version, check_yaml
...
class AutoBackend(nn.Module):
    ...
    def __init__(self,
                 ...
                 verbose=True):
        """
        MultiBackend class for python inference on various platforms using YOLOvision YOLO.

        Args:
            weights (str): The path to the weights file. Default: 'YOLOvisionn.pt'
        ...
        if nn_module:
            ...
            from YOLOvision.yolo.engine.exporter import gd_outputs
            ...
            raise NotImplementedError('YOLOvision TF.js inference is not supported')
    ...
    def forward(self, im, augment=False, visualize=False):
        """
        Runs inference on the YOLOvision MultiBackend model.

...
from Objd.nn.autobackend import check_class_names
from Objd.nn.modules import C2f, Detect, Segment
from Objd.nn.tasks import DetectionModel, SegmentationModel
from Objd.yolo.cfg import get_cfg
from Objd.yolo.utils import (DEFAULT_CFG, LINUX, LOGGER, MACOS, __version__, callbacks, colorstr,
                             get_default_args, yaml_save)
from Objd.yolo.utils.checks import check_imgsz, check_requirements, check_version
from Objd.yolo.utils.files import file_size
from Objd.yolo.utils.ops import Profile
from Objd.yolo.utils.torch_utils import get_latest_opset, select_device, smart_inference_mode
...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        description = f'Objd {self.pretty_name} model ' + f'trained on {Path(self.args.data).name}' \
    ...
    def _export_coreml(self, prefix=colorstr('CoreML:')):
        ...
        class iOSDetectModel(torch.nn.Module):
            # Wrap an Objd YOLO model for iOS export

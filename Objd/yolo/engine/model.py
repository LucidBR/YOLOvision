...
from Objd import yolo  # noqa
from Objd.nn.tasks import (ClassificationModel, DetectionModel, SegmentationModel, attempt_load_one_weight,
                           guess_model_task, nn, yaml_model_load)
from Objd.yolo.cfg import get_cfg
from Objd.yolo.engine.exporter import Exporter
from Objd.yolo.utils import (DEFAULT_CFG, DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, RANK, ROOT, callbacks,
                             is_git_dir, yaml_load)
from Objd.yolo.utils.checks import check_file, check_imgsz, check_pip_update_available, check_yaml
from Objd.yolo.utils.downloads import GITHUB_ASSET_STEMS
from Objd.yolo.utils.torch_utils import smart_inference_mode
...
class YOLO:
    ...
    Methods:
        ...
        predict(source=None, stream=False, **kwargs) -> List[Objd.yolo.engine.results.Results]:
            Performs prediction using the YOLO model.

    Returns:
        list(Objd.yolo.engine.results.Results): The prediction results.
    """
    ...
    def predict(self, source=None, stream=False, **kwargs):
        ...
        is_cli = (sys.argv[0].endswith('yolo') or sys.argv[0].endswith('Objd')) and \
    ...
    def track(self, source=None, stream=False, **kwargs):
        from Objd.tracker import register_tracker
    ...
    def benchmark(self, **kwargs):
        ...
        self._check_is_pytorch_model()
        from Objd.yolo.utils.benchmarks import benchmark

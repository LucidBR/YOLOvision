...
from Objd.nn.tasks import ClassificationModel, attempt_load_one_weight
from Objd.yolo import v8
from Objd.yolo.data import build_classification_dataloader
from Objd.yolo.engine.trainer import BaseTrainer
from Objd.yolo.utils import DEFAULT_CFG, LOGGER, RANK, colorstr
from Objd.yolo.utils.torch_utils import is_parallel, strip_optimizer
...
class ClassificationTrainer(BaseTrainer):
    ...
    def setup_model(self):
        ...
        # Load a YOLO model locally, from torchvision, or from Objd assets

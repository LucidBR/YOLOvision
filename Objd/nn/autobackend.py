...
from Objd.yolo.utils import LINUX, LOGGER, ROOT, yaml_load
from Objd.yolo.utils.checks import check_requirements, check_suffix, check_version, check_yaml
from Objd.yolo.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    ...
    def __init__(self,
                 ...
                 verbose=True):
        """
        MultiBackend class for python inference on various platforms using Objd YOLO.
        ...
        if nn_module:
            ...
            from Objd.nn.tasks import attempt_load_weights
            ...
            from Objd.yolo.engine.exporter import gd_outputs
